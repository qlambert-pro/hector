...
let rec goto_jump_toback st = function
    []-> true
  | (a,b)::t-> match Ast_c.unwrap st with
                 Ast_c.Jump (Ast_c.Goto name) -> if (Def.compare_names name a) then
                                                    if(List.length b)>0 then 
						       if(Def.find_startline_no b) < (Def.find_startline_no [st]) then true
                                                       else false
                                                    else true
                                                 else goto_jump_toback st t
                |_ -> true


let rec return_specific_exp e = 

    match  e with
    | (((Ast_c.Constant (Ast_c.Int("0", _))), typ), ii)-> (Var_dec.zero_rtrn_ehc:= !Var_dec.zero_rtrn_ehc + 1; (* for PHP true *) false)
    | (((Ast_c.ParenExpr (e)), typ), ii) -> return_specific_exp e
    | (((Ast_c.Constant (Ast_c.Int("1", _))), typ), ii)-> false  (* for PHP false *)
    | (((Ast_c.Unary (e1, Ast_c.UnMinus)), typ), ii) -> true
    | (((Ast_c.Cast    (t, (((Ast_c.Unary (e1, Ast_c.UnMinus)), typ1), ii1))), typ), ii)-> true
    | (((Ast_c.Cast    (t, (((Ast_c.FunCall  ((((Ast_c.Ident (Ast_c.RegularName(s,ii3))), typ2), ii2), es)), typ1), ii1))), typ), ii)->
                                                                            	if s =~ "ERR_PTR" || s =~ "PTR_ERR" then true
                                                                                else (Var_dec.func_rtrn_ehc:= !Var_dec.func_rtrn_ehc + 1;
                                                                                   false)
    | (((Ast_c.Unary ((((Ast_c.Constant (Ast_c.Int("0", _))), typ1), ii1), Ast_c.Tilde)), typ), ii) -> true
    | (((Ast_c.ParenExpr ((((Ast_c.Unary (e1, Ast_c.UnMinus)), typ), ii))), typ2), ii2)-> true 
    | (((Ast_c.FunCall   ((((Ast_c.Ident (Ast_c.RegularName(s,ii))), typ), ii1), es)), typ1), ii2) -> if s =~ "ERR_PTR" || s =~ "PTR_ERR" then true 
                                                                                                      else (Var_dec.func_rtrn_ehc:= !Var_dec.func_rtrn_ehc + 1;
													    false)
    | (((Ast_c.Ident (Ast_c.RegularName(id,ii2))), typ), ii)-> (Var_dec.oth_rtrn_ehc:= !Var_dec.oth_rtrn_ehc + 1; 
							       false
							      )
    | (((Ast_c.ParenExpr ((((Ast_c.Ident (Ast_c.RegularName(id,ii2))), typ), ii))), typ2), ii3)-> (Var_dec.oth_rtrn_ehc:= !Var_dec.oth_rtrn_ehc + 1; true)
    | (((Ast_c.ParenExpr ((((Ast_c.Constant (Ast_c.Int("0", _))), typ1), ii1))), typ), ii)-> (Var_dec.zero_rtrn_ehc:= !Var_dec.zero_rtrn_ehc + 1; true)
    | _-> Var_dec.oth_rtrn_ehc:= !Var_dec.oth_rtrn_ehc + 1; false


let rec return_specific_exp_list = function
  []-> false
  | h::t-> if (return_specific_exp h) then true
           else return_specific_exp_list t


let rec code_for_goto name = function
     []->[]
  |  (label,code)::t -> if (Def.compare_names label name) then
                           (if(Def.inner_blk code) then [] else code )
	                else code_for_goto name t


let rec lbl_list_has_goto name = function
  []-> false
  | (a,b)::t-> if (Def.compare_names a name) then true else lbl_list_has_goto name t
...
let rec gather_goto_code lbl_list goto_code name_list = function
  ...
  |h::t->
          ...
          |   Ast_c.Jump (Ast_c.Goto name) -> 
	                                      if (not (lbl_list_has_goto name lbl_list)) then gather_goto_code lbl_list goto_code name_list t
	                                      else if (not(goto_jump_toback h lbl_list)) && (lbl_list_has_goto name lbl_list) && 
						(not(Def.name_exists_in_list name name_list)) then(
                                                  let new_goto_code = code_for_goto name lbl_list in
                                                  if (List.length new_goto_code) = 0 then gather_goto_code lbl_list [] name_list []
...
let rec return_or_goto_exists = function                                                
    []->false                                  
...
let rec invert_st st = 
   ...
   | Ast_c.ExprStatement (Some (((Ast_c.Binary   ((((Ast_c.ParenExpr (e1)), typ2), ii2), (Ast_c.Logical Ast_c.Eq), 
						  ((Ast_c.Ident (Ast_c.RegularName("NULL",ii3)), typ1), ii1))), typ), ii))->
     ([(Ast_c.ExprStatement (Some (((Ast_c.Assignment (e1, 
						      (Ast_c.SimpleAssign), (((Ast_c.Ident (Ast_c.RegularName("NULL",[]))), typ), []))), typ), [])),[])],
     [(Ast_c.ExprStatement (Some e1),[])])


   |  Ast_c.ExprStatement (Some (((Ast_c.Assignment (e1, op, e2)), typ), ii)) ->
         ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e1, op, e2), typ), [])),[])],
         [((Ast_c.ExprStatement (Some ((Ast_c.Assignment (e1, op, (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[]))])

   |  Ast_c.ExprStatement (Some (((Ast_c.FunCall  ((((Ast_c.Ident (Ast_c.RegularName("IS_ERR",ii3))), typ1), ii1), es) ), typ), ii)) ->
        if (List.length es> 0) then
                 ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((List.hd (Def.remove_optionlist (Def.create_argslist [] es))), (Ast_c.SimpleAssign),
                 (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
                 [(Ast_c.ExprStatement (Some (List.hd (Def.remove_optionlist (Def.create_argslist [] es)))),[])])

        else ([st],[st])



   |    Ast_c.ExprStatement (Some (((Ast_c.FunCall  ((((Ast_c.Ident (Ast_c.RegularName("dma_mapping_error",ii3))), typ1), ii1), es) ), typ), ii)) ->
        if (List.length es> 0) then
                 ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((List.hd (Def.remove_optionlist (Def.create_argslist [] es))), (Ast_c.SimpleAssign),
                 (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
                 [(Ast_c.ExprStatement (Some (List.hd (Def.remove_optionlist (Def.create_argslist [] es)))),[])])
   ...
   |   Ast_c.ExprStatement (Some (((Ast_c.FunCall  ((((Ast_c.Ident (Ast_c.RegularName("is_bad",ii3))), typ1), ii1), es) ), typ), ii)) ->
        if (List.length es> 0) then
                 ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((List.hd (Def.remove_optionlist (Def.create_argslist [] es))), (Ast_c.SimpleAssign),
                 (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
                 [(Ast_c.ExprStatement (Some (List.hd (Def.remove_optionlist (Def.create_argslist [] es)))),[])])
   ...
   |   Ast_c.ExprStatement (Some (((Ast_c.FunCall  ((((Ast_c.Ident (Ast_c.RegularName("IS_ERR_OR_NULL",ii3))), typ1), ii1), es) ), typ), ii)) ->
        if (List.length es> 0) then
                 ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((List.hd (Def.remove_optionlist (Def.create_argslist [] es))), (Ast_c.SimpleAssign),
                 (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
                 [(Ast_c.ExprStatement (Some (List.hd (Def.remove_optionlist (Def.create_argslist [] es)))),[])])
   ...
   |  Ast_c.ExprStatement (Some (((Ast_c.Binary   ((((Ast_c.FunCall (e1, es)), typ1), ii1), 
        ...
        if (List.length es = 1) then
                 ...
                 ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((((Ast_c.FunCall (e1, es)), typ1), ii1), (Ast_c.SimpleAssign),
                 (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
                 [(Ast_c.ExprStatement (Some (((Ast_c.FunCall (e1, es)), typ1), ii1)),[])])
   ...
   |  Ast_c.ExprStatement (Some((Ast_c.FunCall (((Ast_c.Ident (Ast_c.RegularName("unlikely",ii3)), typ1), ii1), es), typ), ii)  ) ->
        
            let args_list = Def.remove_optionlist (Def.create_argslist [] es) in
            invert_st ((Ast_c.ExprStatement (Some (List.hd args_list))),[])

         
 
  |   Ast_c.ExprStatement (Some (((Ast_c.Unary    ((((Ast_c.ParenExpr ((((Ast_c.FunCall  
                  ((((Ast_c.Ident (Ast_c.RegularName("IS_ERR",ii1))), typ4), ii4), es)), typ3), ii3))), typ2), ii2), Ast_c.Not)), typ), ii)) ->
        if (List.length es = 1) then
           ([(Ast_c.ExprStatement (Some (List.hd (Def.remove_optionlist (Def.create_argslist [] es)))),[])],
           [(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((List.hd (Def.remove_optionlist (Def.create_argslist [] es))), (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])])
  ...
  |   Ast_c.ExprStatement (Some (((Ast_c.Unary ((((Ast_c.FunCall  (e, es)), typ1), ii1), Ast_c.Not)), typ), ii))-> 

        let ptr_args = Def.find_ptr_args_list ((Def.remove_optionlist (Def.create_argslist [] es))) in
        if (List.length ptr_args > 0) then
                 ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((List.hd ptr_args), (Ast_c.SimpleAssign),
                 (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
                 [(Ast_c.ExprStatement (Some (List.hd (Def.remove_optionlist (Def.create_argslist [] es)))),[])])

        else 
                 ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((((Ast_c.FunCall  (e, es)), typ1), ii1), (Ast_c.SimpleAssign),
                 (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
                 [(Ast_c.ExprStatement (None),[])])

  |    Ast_c.ExprStatement (Some (((Ast_c.Binary   (e1, (Ast_c.Logical Ast_c.OrLog), e2)), typ), ii))->
         let (norm_exp1, opp_exp1)  = invert_st ((Ast_c.ExprStatement (Some e1)),[]) in
         let (norm_exp2, opp_exp2)  = invert_st ((Ast_c.ExprStatement (Some e2)),[]) in
  ...
  |    Ast_c.ExprStatement (Some (((Ast_c.FunCall  (e, es)), typ1), ii1))->
        ...
        if (List.length es =0) then
                 (
                 [(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((((Ast_c.FunCall  (e, es)), typ1), ii1), (Ast_c.SimpleAssign),
                 (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ1), [])), typ1), [])),[])], [(Ast_c.ExprStatement (Some (((Ast_c.FunCall  (e, es)), typ1), ii1)),[])])
  ...
  |    Ast_c.ExprStatement (Some (((Ast_c.Unary    ((((Ast_c.ParenExpr (((Ast_c.FunCall ((e, es)), typ3), ii3))), typ2), ii2), Ast_c.Not)), typ), ii)) ->
        if (List.length es = 1) then
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((List.hd (Def.remove_optionlist (Def.create_argslist [] es))), (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
           [(Ast_c.ExprStatement (Some (List.hd (Def.remove_optionlist (Def.create_argslist [] es)))),[])])
        else 
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (((Ast_c.FunCall ((e, es)), typ3), ii3), (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
           [(Ast_c.ExprStatement (Some ((Ast_c.FunCall ((e, es)), typ3), ii3)),[])])


  |   Ast_c.ExprStatement (Some (((Ast_c.Binary ((((Ast_c.FunCall  (e, es)), typ2), ii2), 
           (Ast_c.Logical Ast_c.Eq),(((Ast_c.Ident (Ast_c.RegularName("NULL",ii3))), typ1), ii1))), typ), ii)) ->
        if (List.length es = 1) then
                 ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((List.hd (Def.remove_optionlist (Def.create_argslist [] es))), (Ast_c.SimpleAssign),
  ...
  |    Ast_c.ExprStatement (Some (((Ast_c.Binary ((((Ast_c.FunCall  ((((Ast_c.Ident (Ast_c.RegularName("IS_EER",ii5))), typ4), ii4), es)), typ2), ii2),
           (Ast_c.Logical Ast_c.Eq),(((Ast_c.Ident (Ast_c.RegularName("NULL",ii3))), typ1), ii1))), typ), ii)) ->
        if (List.length es = 1) then
                 ([(Ast_c.ExprStatement (Some (List.hd (Def.remove_optionlist (Def.create_argslist [] es)))),[])],
	         [(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((List.hd (Def.remove_optionlist (Def.create_argslist [] es))), (Ast_c.SimpleAssign),
  ...
  |     Ast_c.ExprStatement (Some (((Ast_c.Binary ((((Ast_c.FunCall  ((((Ast_c.Ident (Ast_c.RegularName("IS_EER",ii5))), typ4), ii4), es)), typ2), ii2),
   ...
   |  Ast_c.ExprStatement (Some (((Ast_c.Unary ((((Ast_c.ParenExpr ((((Ast_c.Assignment 
                 (e1, (Ast_c.SimpleAssign), e2)), typ2), ii2))), typ1), ii1), Ast_c.Not)), typ), ii)) -> 
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e1, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],
           [(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e1, (Ast_c.SimpleAssign), e2), typ), [])),[])]
           )

   |   Ast_c.ExprStatement (Some (((Ast_c.Binary (e11, (Ast_c.Logical Ast_c.Eq),(((Ast_c.Ident (Ast_c.RegularName("NULL",ii3))), typ1), ii1))), typ), ii)) ->
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e11, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],[(Ast_c.ExprStatement (Some e11),[])])

   |  Ast_c.ExprStatement (Some (((Ast_c.Binary (e11, (Ast_c.Logical Ast_c.NotEq),(((Ast_c.Ident (Ast_c.RegularName("NULL",ii3))), typ1), ii1))), typ), ii)) ->
           ([(Ast_c.ExprStatement (Some e11),[])],[(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e11, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])])

   |   Ast_c.ExprStatement (Some (((Ast_c.Binary ((((Ast_c.Ident (Ast_c.RegularName("NULL",ii3))), typ1), ii1),(Ast_c.Logical Ast_c.Eq),e11)), typ), ii)) ->
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e11, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],[(Ast_c.ExprStatement (Some e11),[])])

   |    Ast_c.ExprStatement (Some (((Ast_c.Binary ((((Ast_c.Ident (Ast_c.RegularName("NULL",ii3))), typ1), ii1),(Ast_c.Logical Ast_c.NotEq),e11)), typ), ii)) ->
           ([(Ast_c.ExprStatement (Some e11),[])],[(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e11, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])])

   |   Ast_c.ExprStatement (Some (((Ast_c.Binary   (((((Ast_c.FunCall  (e, es)), typ2), ii2)), 
						    (Ast_c.Logical Ast_c.Eq), ((Ast_c.Constant (Ast_c.Int ("0", _)), typ1), ii1))), typ), ii)) ->
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],[(Ast_c.ExprStatement (None),[])])



   |  Ast_c.ExprStatement (Some (((Ast_c.Binary   (e1, (Ast_c.Logical Ast_c.Eq), ((Ast_c.Constant (Ast_c.Int ("0", _)), typ1), ii1))), typ), ii)) ->
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e1, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],[(Ast_c.ExprStatement (Some e1),[])])

   |   Ast_c.ExprStatement (Some (((Ast_c.Binary   (e1, (Ast_c.Logical Ast_c.Inf), ((Ast_c.Constant (Ast_c.Int ("0", _)), typ1), ii1))), typ), ii)) ->
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e1, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],[(Ast_c.ExprStatement (Some e1),[])])

   |  Ast_c.ExprStatement (Some (((Ast_c.Binary   (e1, (Ast_c.Logical Ast_c.NotEq), ((Ast_c.Constant (Ast_c.Int ("0", _)), typ1), ii1))), typ), ii)) ->
           ([(Ast_c.ExprStatement (Some e1),[])], [(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e1, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])])

   |    Ast_c.ExprStatement (Some (((Ast_c.ParenExpr ((((Ast_c.Unary (e11, Ast_c.Not)), typ), ii))), typ1), ii1) )->
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e11, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])],[(Ast_c.ExprStatement (Some e11),[])])

   |  Ast_c.ExprStatement (Some (((Ast_c.Unary ((((Ast_c.ParenExpr (e11)), typ1), ii1), Ast_c.Not)), typ), ii))  ->
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e11, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ1), [])), typ1), [])),[])],[(Ast_c.ExprStatement (Some e11),[])])
   ...
   |  Ast_c.ExprStatement (Some (((Ast_c.Unary (e11, Ast_c.Not)), typ), ii))  ->
	 ...
	 Def.IsPtr  ->
      ...
      | Def.IsntPtr-> 
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e11, (Ast_c.SimpleAssign),
           (( Ast_c.Ident (Ast_c.RegularName("0",[])), typ), [])), typ), [])),[])],[(Ast_c.ExprStatement (Some e11),[])])

       )


   |    Ast_c.ExprStatement (Some (((Ast_c.Binary ((((Ast_c.FunCall  (e, es)), typ1), ii1), (Ast_c.Logical Ast_c.Eq),e22)), typ), ii)) ->
       ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment ((((Ast_c.FunCall  (e, es)), typ1), ii1), (Ast_c.SimpleAssign),e22), typ), [])),[])],
        [])

   |   Ast_c.ExprStatement (Some (((Ast_c.Binary (e11, (Ast_c.Logical Ast_c.Eq),e22)), typ), ii)) ->
           ([(Ast_c.ExprStatement (Some ((Ast_c.Assignment (e11, (Ast_c.SimpleAssign),e22), typ), [])),[])],[(Ast_c.ExprStatement (Some e11),[])])


   |   Ast_c.ExprStatement (Some (((Ast_c.FunCall  (e, es)), typ), ii))->Printf.printf "Function call : %s\n" (Dumper.dump e);
        if (List.length es = 1) then
                 ([(Ast_c.ExprStatement (Some (List.hd (Def.remove_optionlist (Def.create_argslist [] es)))),[])],
                 [(Ast_c.ExprStatement (None),[])]
                 )
   ...
   |  Ast_c.ExprStatement (Some ((exp, typ), ii))->
           ([(Ast_c.ExprStatement (Some ((exp, typ), ii)),[])],
           [(Ast_c.ExprStatement (Some ((Ast_c.Assignment (((exp, typ), ii), (Ast_c.SimpleAssign), (( Ast_c.Ident (Ast_c.RegularName("NULL",[])), typ), [])), typ), [])),[])])
   |_->([st],[st])
  ...
  | h::t-> let start_line = Def.find_startline_no (Def.create_stmtlist h) in
           ...
           if(fin_lineno>= start_line && fin_lineno<=end_line) || fin_lineno> end_line then
             ...
             |   Ast_c.Labeled (Ast_c.Label (name, st)) ->
                 ...
                 else if (not(return_or_goto_exists (Def.create_stmtlist st))) then
                    let new_exe_paths = generate_exe_paths_simple fin_lineno exe_paths lbl_list (Def.create_stmtlist st) in
                    generate_exe_paths_simple fin_lineno new_exe_paths lbl_list t
	     ...
	     |  Ast_c.Compound statxs -> 
                 if (fin_lineno>= start_line && fin_lineno<=end_line) then
                    ...
                    generate_exe_paths_simple fin_lineno new_exe_paths lbl_list t
                 else if (not(return_or_goto_exists (Def.create_stmtlist h))) then
                    let new_exe_paths = generate_exe_paths_simple fin_lineno exe_paths lbl_list (Def.create_stmtlist h) in
                    generate_exe_paths_simple fin_lineno new_exe_paths lbl_list t
                 else generate_exe_paths_simple fin_lineno exe_paths lbl_list t
             |  Ast_c.Selection  (Ast_c.If (e, st1, st2)) -> 
		  ...
		  |  (((Ast_c.Binary   (e1, (Ast_c.Logical Ast_c.AndLog), e2)), typex), iiex)->
                      ...
                      let (norm_exp2,opp_exp2) = invert_st ((Ast_c.ExprStatement (Some e2)),[]) in
                      ((norm_exp1@norm_exp2),(opp_exp1@opp_exp2))
		  |  _->let (norm_exp,opp_exp)= invert_st ((Ast_c.ExprStatement (Some e)),[]) in
                      (norm_exp,opp_exp)
                 ) in


                  let exe_paths1 =   if (List.length exe_paths) = 0 then (exe_paths@[norm_exp])
                                      else (append_exe_path norm_exp exe_paths) in
                  let exe_paths2 =  if (List.length exe_paths) = 0 then (exe_paths@[opp_exp])
                                    else (append_exe_path opp_exp exe_paths)
                  in
                  ...
                  let exe_paths1 =   if (List.length exe_paths1) = 0 then (exe_paths1@[goto_code])
                                     else (append_exe_path goto_code exe_paths1)
                  in
		  exe_paths1)
                  ...
                  let exe_paths2 =   if (List.length exe_paths2) = 0 then (exe_paths2@[goto_code])
                                     else (append_exe_path goto_code exe_paths2)
                  in
		    exe_paths2
                  ...
                  else if (not(return_or_goto_exists (Def.create_stmtlist st1))) && (not(return_or_goto_exists (Def.create_stmtlist st2))) && ((List.length st2_new) >0)then
                    let new_exe_paths1 = generate_exe_paths_simple fin_lineno exe_paths1 lbl_list (Def.create_stmtlist st1) in
                    let new_exe_paths2 = generate_exe_paths_simple fin_lineno exe_paths2 lbl_list (Def.create_stmtlist st2) in
                      generate_exe_paths_simple fin_lineno (new_exe_paths1) lbl_list t
                  ...
                  else if (not(return_or_goto_exists (Def.create_stmtlist st1))) then
                    let new_exe_paths1 = generate_exe_paths_simple fin_lineno exe_paths1 lbl_list (Def.create_stmtlist st1) in
                    generate_exe_paths_simple fin_lineno new_exe_paths1 lbl_list t

                  else if (not(return_or_goto_exists (Def.create_stmtlist st2))) && ((List.length st2_new) >0)  then(
                    let new_exe_paths2 = generate_exe_paths_simple fin_lineno exe_paths2 lbl_list (Def.create_stmtlist st2) in
                    generate_exe_paths_simple fin_lineno new_exe_paths2 lbl_list t)
             ...
             |  Ast_c.Selection  (Ast_c.Switch (e, st)) -> 
                  let exe_paths1 = if (List.length exe_paths) = 0 then (exe_paths@[[((Ast_c.ExprStatement (Some e)),[])]])
                                   else (append_exe_path [((Ast_c.ExprStatement (Some e)),[])] exe_paths)
                  in
		  ...
		  |  _->let (norm_exp,opp_exp)= invert_st ((Ast_c.ExprStatement (Some e)),[]) in
                  ...
                  let exe_paths1 = if (List.length exe_paths) = 0 then (exe_paths@[norm_exp])
                                   else (append_exe_path norm_exp exe_paths)
                  in
                  let exe_paths2 = if (List.length exe_paths) = 0 then (exe_paths@[opp_exp])
                                   else (append_exe_path opp_exp exe_paths)
                  in
	     ...
	     |   Ast_c.Jump (Ast_c.GotoComputed e) -> generate_exe_paths_simple fin_lineno exe_paths lbl_list t
             | _->
                   ...
                   generate_exe_paths_simple fin_lineno (append_exe_path [h] exe_paths) lbl_list t
  ...
  | h::t-> 
      match Ast_c.unwrap h with
	   ...
	   |  Ast_c.Jump (Ast_c.ReturnExpr (((Ast_c.Assignment (e1, op, e2)), typ), ii))-> 
	       if (return_specific_exp e2) then true else false
	   ...
	   | Ast_c.Jump (Ast_c.ReturnExpr (((Ast_c.Cast    (t, (((Ast_c.ParenExpr ((((Ast_c.Ident (ident)), typ2), ii2))), typ1), ii1))), typ), ii))-> true  
           ...
           | Ast_c.Jump (Ast_c.ReturnExpr e1) -> if (return_specific_exp e1) then true else false
...
let remove_not_errorblks func_name iifunc1 exp lbl_list prog stmtlist part blk_strtlineno = 
   ...
   | Some st->
		    ...
		    let fin_lineno = blk_strtlineno in
                    ...
                    if(return_specific_exp_list id_values) then false
                    else
                       (  
		         match part with
